...
def __init__(event):
    """Initialisation du programme"""
    global w, X, Y, bgMP, bgMJ, bgMC, bg_i, game_logo_i, button_jouer_i, button_comptes_i, button_quit_i, button_bj_i, button_rr_i, button_return_i, button_compte_empty_i, button_remove_compte_i
...
def MenuComptes():
    ...
    button_remove_compte = bgMC.create_image(592, 583, anchor=NW, image=button_compte_empty_i) #Bouton remove compte

...
def Database_Load():
    global pass_ok, money, xp, xp_need, pseudo, pseudo2
...
def Database_Create():
    ...
    if pseudo2 in user1:
        ...
        print("Bonjour", pseudo, ". Vous êtes niveau", level)
...
def MenuPrincipal():
    ...
    bgMP.create_text(0, 270, anchor=NW, text="Nique ta mère la pute !!!!!!!!!!!", font="Arial 16 bold", fill="red")
